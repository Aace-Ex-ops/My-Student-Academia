...
// Major to Career Targets Mapping (12 Comprehensive Disciplines)
const majorCareerMap: Record<string, string[]> = {
  "Computer Science & Engineering": [
    "Full-Stack Software Engineer",
    "Cloud & Distributed Systems Architect",
    "DevOps & Platform SRE Engineer",
    "Systems & Compiler Engineer",
    "Database & Distributed Storage Engineer",
    "Mobile App Developer (iOS/Android)",
  ],
  "Artificial Intelligence & Data Science": [
    "Generative AI & LLM Systems Engineer",
    "Deep Learning & Neural Network Researcher",
    "Computer Vision & Spatial AI Specialist",
    "NLP & Speech Intelligence Scientist",
    "AI Product Manager (AI-PM)",
    "Big Data Platform & ML-Ops Engineer",
  ],
  "Electrical, Electronics & VLSI": [
    "VLSI Chip Design & Verification Engineer",
    "Embedded Systems & RTOS Developer",
    "Robotics Hardware & Actuator Specialist",
    "FPGA & Hardware Acceleration Engineer",
    "IoT Systems & Smart Grid Architect",
    "Semiconductor & Quantum Circuit Specialist",
  ],
  "Mechanical & Aerospace Engineering": [
    "Aerospace Systems & Flight Dynamics Engineer",
    "Autonomous Drone & Swarm Robotics Designer",
    "Automotive CAD/CAM & FEA Simulation Lead",
    "Thermodynamics & Electric Powertrain Specialist",
    "Mechatronics Control & Precision Systems Engineer",
    "Computational Fluid Dynamics (CFD) Analyst",
  ],
  "Civil, Environmental & Structural Engineering": [
    "High-Rise Structural Engineering Specialist",
    "Smart City Infrastructure & Transportation Planner",
    "Geotechnical & Foundation Engineer",
    "Environmental Sustainability & Water Resources Lead",
    "BIM (Building Information Modeling) Coordinator",
    "Disaster-Resilient Architecture Consultant",
  ],
  "Biotechnology, Bioinformatics & Genetics": [
    "Computational Genomics & Bioinformatics Scientist",
    "CRISPR & Synthetic Biology Researcher",
    "Pharmaceutical R&D & Drug Discovery Lead",
    "Biomedical Instrumentation & Device Designer",
    "Clinical Genomics & Oncology Data Specialist",
    "Bio-Process & Vaccine Development Engineer",
  ],
  "Business, Fintech & Quantitative Finance": [
    "Quantitative Financial Trader & Algorithmic Strategist",
    "Fintech Product Manager (Payments / DeFi)",
    "Venture Capital & Tech Investment Analyst",
    "Management & Digital Transformation Consultant",
    "Risk Analytics & Financial Econometrician",
    "Blockchain & Smart Contract Economics Lead",
  ],
  "UI/UX Design, HCI & Interactive Media": [
    "Principal UI/UX & Design Systems Architect",
    "AR/VR Spatial Computing & 3D Interactive Designer",
    "Cognitive UX Researcher & Usability Specialist",
    "Interaction Designer & Micro-Animations Lead",
    "Design Technologist (Creative Coding / WebGL)",
    "Product Design Strategist",
  ],
  "Cybersecurity, Cloud & Ethical Hacking": [
    "Offensive Security Lead & Penetration Tester",
    "Zero-Trust Cloud Security Architect",
    "Threat Intelligence & SOC Incident Responder",
    "Applied Cryptographer & Blockchain Auditor",
    "Application Security (AppSec) DevSecOps Lead",
    "Cyber Defense & Digital Forensics Investigator",
  ],
  "Chemical Engineering & Nanotechnology": [
    "Nano-Materials & Battery Chemistry Engineer",
    "Petrochemical & Polymer Process Specialist",
    "Clean Hydrogen & Renewable Fuels Researcher",
    "Process Optimization & Chemical Plant Architect",
    "Pharmaceutical Formulation Scientist",
    "Catalysis & Surface Chemistry Researcher",
  ],
  "Legal Studies, Cyber Law & Tech Policy": [
    "Cyber Law & Digital Privacy Attorney",
    "AI Governance & Tech Policy Advisor",
    "Intellectual Property (IP) & Patent Specialist",
    "Corporate Fintech & Regulatory Compliance Officer",
    "International Tech Trade & Ethics Counsel",
    "Digital Rights & Data Sovereignty Advocate",
  ],
  "Medical Sciences & Health Informatics": [
    "Electronic Health Record (EHR) Data Architect",
    "Clinical Informatics & Telehealth Specialist",
    "Medical Imaging & AI Diagnostics Researcher",
    "Healthcare Systems & Hospital Operations Analyst",
    "Public Health Epidemiologist & Biostatistician",
    "Precision Medicine & Pharmacogenomics Lead",
  ],
};
